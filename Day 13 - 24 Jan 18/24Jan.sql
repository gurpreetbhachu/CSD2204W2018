...
CREATE TABLE `ac_mast` (
  ...
  `od_limit` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`ac_type`,`ac_no`),
  KEY `cust_no` (`cust_no`),
  CONSTRAINT `ac_mast_ibfk_1` FOREIGN KEY (`cust_no`) REFERENCES `cust_mast` (`cust_no`)
...
INSERT INTO `ac_mast` VALUES ('BRL',3380,5,7026.60,2360.86),('BRL',4220,8,5801.32,1899.98),('LTL',2079,9,7281.11,2604.44),('NOK',4696,1,9790.20,1065.68),('PHP',3971,10,6843.68,2790.22),('PLN',2345,2,8315.07,1581.17),('SOS',2619,4,8444.47,2170.43),('UYU',2476,3,7414.20,1737.69),('VND',3291,7,6072.88,2637.92),('VND',4070,6,5902.90,2587.25);
...
INSERT INTO `cust_mast` VALUES (1,'Lari Membry','05952 Glacier Hill Alley','620 Twin Pines Street','4 Goodland Alley','Paterson','New Jersey'),(2,'Broderic Sartin','13171 Kings Center','5710 Transport Park','4391 Ramsey Center','Savannah','Georgia'),(3,'Adelaida Hallas','0 Blue Bill Park Court','8 Susan Hill','89 Oak Park','El Paso','Texas'),(4,'Boris Calveley','37 Columbus Hill','52 Texas Park','1 Tomscot Drive','Washington','District of Columbia'),(5,'Virginia Cawthorn','597 Milwaukee Street','3 Pankratz Terrace','5952 Lake View Road','Albuquerque','New Mexico'),(6,'Clemmy Briddle','3 John Wall Junction','1 Surrey Court','1227 Bunker Hill Point','Cincinnati','Ohio'),(7,'Shirlee Vosse','1 Arrowood Trail','3 Southridge Plaza','83 Lukken Crossing','Seattle','Washington'),(8,'Kalle Boulding','887 Granby Circle','2 Walton Trail','6 Milwaukee Park','Washington','District of Columbia'),(9,'Cecelia Teresi','618 Sommers Parkway','11331 Maryland Trail','2086 Miller Street','Cleveland','Ohio'),(10,'Mikaela Penwell','1 Mallory Circle','1634 Eastwood Alley','98 Bunting Circle','Saint Louis','Missouri');
...
INSERT INTO `emp_details` VALUES (101,'NEENA','KOCHHAR','NEENA.KOCHHAR@GMAIL.COM','2345678','2002-10-10','AD_VP',18000.00,0.50),(102,'LEX','DE HANN','LEX.HANN@GMAIL.COM','2345678','1995-10-20','AD_VP',18000.00,0.50),(103,'ALEXANDER','HUNOLD','ALEXANDER.HUNOLD@GMAIL.CO','2345678','2002-11-23','IT_PROG',10000.00,0.25),(104,'BRUCE','ERNST','BRUCE.ERNST@GMAIL.COM','2345678','2003-08-24','IT_PROG',7000.00,0.25),(105,'DAVID','AUSTIN','DAVID.AUSTIN@GMAIL.COM','2345678','2005-04-10','IT_PROG',5800.00,0.25),(106,'MARK','KING','MARK@GMAIL,COM','2345678','0000-00-00','IT_PROG',7500.00,0.65),(107,'phil','jones','jone@GMAIL,COM','2345678','0000-00-00','IT_PROG',7500.00,0.65),(108,'phi','jone','jon@GMAIL,COM','2345678','0000-00-00','IT_PROG',7500.00,0.65);
...
INSERT INTO `log_emp_details` VALUES (106,6500.00,'2018-01-24 08:45:15'),(107,6500.00,'2018-01-24 08:59:25'),(108,6500.00,'2018-01-24 09:00:28');
...
INSERT INTO `log_emp_details_update` VALUES ('root@localhost','Update employee Record STEVEN Old Salary :24000.00 New Salary : 25000.00','2018-01-24 09:07:46'),('root@localhost','Update employee Record NEENA Old Salary :17000.00 New Salary : 18000.00','2018-01-24 09:07:46'),('root@localhost','Update employee Record LEX Old Salary :17000.00 New Salary : 18000.00','2018-01-24 09:07:46'),('root@localhost','Update employee Record ALEXANDER Old Salary :9000.00 New Salary : 10000.00','2018-01-24 09:07:46'),('root@localhost','Update employee Record BRUCE Old Salary :6000.00 New Salary : 7000.00','2018-01-24 09:07:46'),('root@localhost','Update employee Record DAVID Old Salary :4800.00 New Salary : 5800.00','2018-01-24 09:07:46'),('root@localhost','Update employee Record MARK Old Salary :6500.00 New Salary : 7500.00','2018-01-24 09:07:46'),('root@localhost','Update employee Record phil Old Salary :6500.00 New Salary : 7500.00','2018-01-24 09:07:46'),('root@localhost','Update employee Record phi Old Salary :6500.00 New Salary : 7500.00','2018-01-24 09:07:46'),('root@localhost','Delete Employee RecordSTEVEN->\nDeleted on ','2018-01-24 09:24:33');
...
-- Dump completed on 2018-01-24 11:16:31
